...
from .views import (device_list_view, device_create_view, device_update_view,
 device_detail_view, device_detail_room_view, device_values_edit_view, device_remove_view)
...
urlpatterns = [
    ...
    path('<str:device_id>/<int:room_id>', device_detail_room_view, name='device_detail_room'),
    path('<str:device_id>/<int:room_id>/edit_values', device_values_edit_view, name='device_detail_edit'),
